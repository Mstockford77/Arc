...
rbj = [
    "Cutbacks.rbj",
    "Dangles.rbj",
    "Duplicate_Geometry.rbj",
    "Geo_on_Geo.rbj",
    "Invalid_Geometry.rbj",
    "Monotonicity.rbj",
    "Multi_Line_Check.rbj",
    "Non_Linear_Segment.rbj",
    "Orphans.rbj"
    ]
...
saveLayer = reviewer_db + "/Geo_Line_Review"
...
saveLayer = reviewer_db + "/Geo_Point_Review"
