...
with open( "Y:/Inventory/Road Inventory Processes/Checks/Logs/Events_logs.txt", "w" ) as logfile:
...
def writeMsg( message ):
    ...
    with open( "Y:/Inventory/Road Inventory Processes/Checks/Logs/Events_logs.txt", "a") as logfile:
...
reviewer_db = "Y:/Inventory/Road Inventory Processes/Checks/Databases/Event_Checks.gdb"
rbj_path = "Y:/Inventory/Road Inventory Processes/Checks/RBJs/Event_Checks/"
# Events 4 added to shoulder script.
rbj = [ "Events1.rbj", "Events2.rbj", "Events3.rbj",  "Events5.rbj", "Null_Not_Null.rbj" ]
...
saveLayer = reviewer_db + "/Events_Line_Review" + ("%s_%s" % (now.month, now.day))
