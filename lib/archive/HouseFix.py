...
def merger(slivers, valids):
    ...
    fixed = []
    to_delete = []
    delete_table = "Y:/Inventory/Road Inventory Processes/Checks/Databases/Slivers_Checks.gdb/dTableHouse"
...
valids = "Database Connections/RDINV.sde/INVDB.OKHouseDistrict"
slivers = "Y:/Inventory/Road Inventory Processes/Checks/Databases/Slivers_Checks.gdb/HouseValids"
