...
with open( "Y:/Inventory/Road Inventory Processes/Checks/Logs/Slivers_logs.txt", "w" ) as logfile:
...
def writeMsg( message ):
    ...
    with open( "Y:/Inventory/Road Inventory Processes/Checks/Logs/Slivers_logs.txt", "a") as logfile: # Open file in append mode
...
reviewer_db = "Y:/Inventory/Road Inventory Processes/Checks/Databases/Slivers.gdb"
